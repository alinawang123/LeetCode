...
public class _27_RemoveElement {
  private static final Logger logger = Logger.getLogger(_27_RemoveElement.class.toString());

  public static void main(String[] args) {
    long startTimeMillis = System.currentTimeMillis();
    Solution solution = new _27_RemoveElement().new Solution();
    logger.info("Solution:" + solution.removeElement(new int[]{0, 0, 1, 1, 1, 2, 2, 3, 3, 4}, 1));
